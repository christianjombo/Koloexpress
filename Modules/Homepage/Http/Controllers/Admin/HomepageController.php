...
namespace Modules\Homepage\Http\Controllers\Admin;
...
class HomepageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('homepage::admin.index', $data);
    }
    ...
    {
        $form = $formBuilder->create('Modules\Homepage\Forms\WidgetForm', [
            'method' => 'POST',
            'url' => route('panel.addons.homepage.store'),
        ]);
        return view('homepage::admin.create', compact('form'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('panel.addons.homepage.index', ['locale' => $widget->locale]);
    }
    ...
    public function edit($id, FormBuilder $formBuilder)
    {
        ...
        $form = $formBuilder->create('Modules\Homepage\Forms\WidgetForm', [
            'method' => 'PUT',
            'url' => route('panel.addons.homepage.update', $id),
            'model' => $widget
        ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('panel.addons.homepage.index', ['locale' => $locale]);
    }
}